...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread a = new Thread(() -> {
            ...
            System.out.println("Текст с максимальным количеством букв " + letter + ": " + maxA);
        });
        a.start();
        ...
        Thread b = new Thread(() -> {
            ...
            System.out.println("Текст с максимальным количеством букв " + letter + ": " + maxB);
        });
        b.start();
        ...
        Thread c = new Thread(() -> {
            ...
            System.out.println("Текст с максимальным количеством букв " + letter + ": " + maxC);
        });
        c.start();
